export function SmallScreenGate() {
  return (
    <div className="small-screen-notice fixed inset-0 z-50 flex-col items-center justify-center gap-4 bg-[var(--color-felt-deep)] p-8 text-center">
      <div aria-hidden className="felt-backdrop absolute inset-0 -z-10" />
      <svg
        aria-hidden
        className="size-14 text-[var(--color-gold)]"
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
      ...
      <h1 className="max-w-lg text-balance font-semibold text-2xl text-[var(--color-ink)] leading-tight">
        Spider Solitaire needs a larger screen
      </h1>
      <p className="max-w-md text-[var(--color-ink-dim)] text-sm">
